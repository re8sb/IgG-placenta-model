...
p.mass_igg = 1.46e5; %molar mass of IgG (1 kDa = 1 g/mol)

% p.k_up = 0.02; p.k_deg = 0.015; p.k_t = 0.01; p.fcrn =1e-5; p.fcgr2b =1e-6; %p.fcrn =1e-4; p.fcgr2b =3e-5;
...
% p.igg3 = 0.4/p.mass_igg; %IgG3 has a higher molar mass (M).
...
p.k_up = 0.09; p.k_deg = 0.4; p.k_t = 0.017; %p.fcrn =1.6e-4; p.fcgr2b =1.6e-5; %p.fcrn =1e-4; %p.fcgr2b =3e-5;
p.v_m = 4; %volume of plasma in mom (L)(Aguree 2019 review)... had previously been using 4 L (total blood vol)
p.v_se = 0.017;
p.v_s = 0.3; %volume of villi (L) (Abdalla et al 2016)
p.v_ee = 0.044;
